...
getquestions().then((APIdata) => {
    ...
    document.getElementById('button').innerHTML = answers[0]
    document.getElementById('button1').innerHTML = answers[1]
    document.getElementById('button2').innerHTML = answers[2]
    document.getElementById('button3').innerHTML = answers[3]
